...
scala -cp cafebabe_2.11-1.2.jar:koolc_2.11-1.3.1.jar koolc.Main --symid --ast $1 > reference.res
echo "Running ours..."
scala -cp target/scala-2.11/classes:cafebabe_2.11-1.2.jar koolc.Main --ast --symid $1 > ours.res
